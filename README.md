...
SI 프로젝트를 수행하다 보면 고객사 현장에 나가 있는 시간이 길어지면서 그룹웨어 로그인이 뜸해지기 쉽다.
그러다 공지사항·인사발령·경조사 같은 중요한 게시물을 뒤늦게 발견하는 경우가 반복됐다.
매번 직접 로그인하지 않아도 새 글이 올라오는 즉시 알림을 받을 수 있도록 이 스크립트를 만들었다.
